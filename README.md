## Quem Sou Eu
-  Sou Rafael, um estudante de *Análise e Desenvolvimento de Sistemas.* 
-  Busco atuar como *Estagiário/Analista/Engenheiro de Dados*.
-  Atualmente estou aprofundando meus conhecimentos em *SQL*.
...
![SAP Badge](https://img.shields.io/badge/SAP-0FAAFF?logo=sap&logoColor=fff&style=flat)
![Canvas Badge](https://img.shields.io/badge/Canvas-E72429?logo=canvas&logoColor=fff&style=flat)

## Meu Roadmap (Próximos 6 meses)

- [x] Criar um README de perfil no GitHub.
- [ ] Ser estagiário com relação à dados.
- [ ] Me aperfeiçoar na Análise de dados com a linguagem SQL.
- [ ] Subir um projeto completo no GitHub (com documentação).
- [ ] Aperfeiçoar meu estudo em inglês. 
...
## Como Falar Comigo
- [Linkedln](https://www.linkedin.com/in/rafael-barbosa-785520329/)
- `rafaelbarbosasilva1204@gmail.com`